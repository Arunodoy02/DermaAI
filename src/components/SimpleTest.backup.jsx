                        ...
                        <div style={{
                            ...
                            <div style={{ marginBottom: '40px' }}>
                                <h4 style={{
                                    ...
                                    <i className="fas fa-chart-bar" style={{ marginRight: '10px', color: '#00c2ff' }}></i>
                                    Detailed Analysis
                                </h4>
                                        ...
                                        <div key={index} style={{
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{
                                                    ...
                                                    width: `${confidence}%`,
                                                    background: index === 0
                                                        ? 'linear-gradient(90deg, #00c2ff 0%, #0066ff 100%)'
                                                        : 'rgba(255,255,255,0.3)',
                                                    borderRadius: '10px',
                                                    transition: 'width 1s ease',
                                                    boxShadow: index === 0 ? '0 0 20px rgba(0, 194, 255, 0.5)' : 'none'
                                                }} />
                                            </div>
                                        </div>
                                    ))}
